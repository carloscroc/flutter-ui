...
- TODO: maintainers to set `RATIFICATION_DATE` after review if different from merge date.
- Optional: keep the canonical copy at `.specify/memory/constitution.md` and use this as the human-visible version in `.github/`.
